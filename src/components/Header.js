...
const Header = () => {
  ...
  const handleScroll = () => {
    ...
    // If the user is scrolling up, set the transform style property to translateY(0)
    if (currentScrollPosition < previousScrollPosition.current) {
      boxRef.current.style.transform = "translateY(0)";
    }
    // If the user is scrolling down, set the transform style property to translateY(-200px)
